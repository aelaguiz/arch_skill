...
Resolve working context in this order: (1) explicit user context such as paths, modules, topics, or stop conditions; (2) active arch artifacts when they clearly exist, such as the current plan doc, worklog, related docs, or a clean implementation audit; (3) otherwise the repo docs surface itself.
