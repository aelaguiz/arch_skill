...
Root ledger shape, controller block, status vocabulary, and cleanup lifecycle for the audit-loop-sim workflow.
...
- ## Phase 1: Triage (complete/in-progress) — with subsections 1A: Journey And Surface Inventory, 1B: Automation And Harness Inventory, 1C: Risk Front Ranking, 1D: Proof Plan For Current Front
- ## Phase 2: Findings
