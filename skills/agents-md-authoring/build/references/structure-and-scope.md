...
Precedence, root vs path-local placement, overrides, and directory strategy. Use this document when deciding where AGENTS.md guidance should live, how precedence works, and when an override is safer than inheritance.
...
- `AGENTS.override.md` replaces the normal file for that directory rather than extends it
...
- repo-wide plain-English communication rules
...
- local jargon or shorthand that needs stricter translation rules than root
...
- root already owns the communication invariant and the subtree has no special local jargon to ban or translate
