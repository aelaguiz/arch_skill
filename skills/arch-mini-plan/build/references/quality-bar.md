...
Strong vs weak bars for the blocks mini mode owns. Core doctrine lives in references/arch-operating-doctrine.md and references/controller-lifecycle.md. This document owns only the mini-plan-specific quality bar.
