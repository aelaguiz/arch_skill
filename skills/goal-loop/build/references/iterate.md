...
Run exactly one high-information bet and append one honest worklog entry. Core doctrine and lifecycle live in references/controller-lifecycle.md. This document documents only the iterate-mode additions.
...
- We will look at the results and decide later.
