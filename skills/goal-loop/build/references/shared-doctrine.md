...
Loop discipline, bet quality, and anti-sidetrack rules specific to goal-loop. Shared operating doctrine lives in references/arch-operating-doctrine.md. Shared controller lifecycle doctrine lives in references/controller-lifecycle.md. This document documents only the goal-loop-specific additions.
