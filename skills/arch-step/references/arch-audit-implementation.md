...
- a reader can tell whether all code is authorized by the approved contract

Audit against the original human anchors, pre-approval convergence closure, and
