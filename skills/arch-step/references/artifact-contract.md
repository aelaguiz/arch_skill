...
the smallest evidenced same-contract convergence closure. Sign off the contract
before the first implementation edit or dispatch. After sign-off, an agent may
complete the approved closure, subtract unauthorized work, or ask for a human
...
Additional canonical entry shape for post-approval human-approved expansion:
